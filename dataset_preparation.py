"""original code by RUdrakshTuwani slightly touched because I am working on Ligue 1
and the data is a little different using the same dataset"""
...
#load data from http://football-data.co.uk/francem.php into dataframes
#raw_data_1 = pd.read_csv('2000-2001.csv') #cannot use the first two because there was only 18 teams before 2002-2003
#raw_data_2 = pd.read_csv('2001-2002.csv')
raw_data_3 = pd.read_csv('2002-2003.csv')
raw_data_4 = pd.read_csv('2003-2004.csv')
raw_data_5 = pd.read_csv('2004-2005.csv')
raw_data_6 = pd.read_csv('2005-2006.csv')
raw_data_7 = pd.read_csv('2006-2007.csv')
raw_data_8 = pd.read_csv('2007-2008.csv')
raw_data_9 = pd.read_csv('2008-2009.csv')
raw_data_10 = pd.read_csv('2009-2010.csv')
raw_data_11 = pd.read_csv('2010-2011.csv')
raw_data_12 = pd.read_csv('2011-2012.csv')
raw_data_13 = pd.read_csv('2012-2013.csv')
raw_data_14 = pd.read_csv('2013-2014.csv')
raw_data_15 = pd.read_csv('2014-2015.csv')
raw_data_16 = pd.read_csv('2015-2016.csv')
raw_data_17 = pd.read_csv('2016-2017.csv')
raw_data_18 = pd.read_csv('2017-2018.csv')
...
"""
#we will only use data that is available before the game to make our prediction
...
def parse_date(date):
    if date == '':
    	...
    	return dt.strptime(date, '%d/%m/%y').date() #dd/mm/yy
...
def parse_date_other(date):
    if date == '':
        ...
        return dt.strptime(date, '%d/%m/%Y').date() #dd/mm/yyyy
...
raw_data_7.Date = raw_data_7.Date.apply(parse_date_other)          # The date format for this dataset is different   
...
playing_statistics_17 = raw_data_16[columns_req]
playing_statistics_18 = raw_data_16[columns_req]
...
#get cumulated points to date during the season
...
Standings = pd.read_csv("Ligue1Standings.csv")
...
#treatment done --> final dataframe
...
#narrow the pb to Home Win or Not Home Win, comment to predict who will win regardless of home or away
def only_hw(string):
    if string == 'H':
        return 'H'
    else:
